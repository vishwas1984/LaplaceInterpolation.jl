...
"""
function nablasq_grid(n::Int64, h::Float64 = 1.0, bc = 1)
  o = ones(n) / h
...
"""
function nablasq_grid(Nx::Int64, Ny::Int64, h::Float64, k::Float64, bc)
  o1 = ones(Nx) / h
...
function matern_2d_grid(mat::Matrix, discard::Vector, m::Int64 = 1, eps = 0.0, 
    ...
    A2D = nablasq_grid(rows, columns, h, k, bc)
    sizeA = size(A2D, 1)
